...
/**
 * Add CheqMate links to course navigation
 */
function assignsubmission_cheqmate_extend_navigation_course($navigation, $course, $context) {
    ...
    // CheqMate Course Settings
    $settingsurl = new moodle_url(
        '/mod/assign/submission/cheqmate/course_settings.php',
        ['courseid' => $course->id]
    );
    ...
    // Download Student Assignments Page
    $downloadurl = new moodle_url(
        '/mod/assign/submission/cheqmate/select_user_download.php',
        ['courseid' => $course->id]
    );
...
/**
 * Fragment callback for AJAX operations (Clear Cache)
 */
